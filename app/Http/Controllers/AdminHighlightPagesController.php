<?php namespace App\Http\Controllers;
	...
	class AdminHighlightPagesController extends \crocodicstudio_voila\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->table = "highlight_pages";
			# END CONFIGURATION DO NOT REMOVE THIS LINE

			# START COLUMNS DO NOT REMOVE THIS LINE
			$this->col = [];
			$this->col[] = ["label"=>"Image","name"=>"image","image"=>true];
			$this->col[] = ["label"=>"Page","name"=>"cms_moduls_id","join"=>"cms_moduls,name"];
			$this->col[] = ["label"=>"Active","name"=>"active"];
			# END COLUMNS DO NOT REMOVE THIS LINE

			# START FORM DO NOT REMOVE THIS LINE
			$this->form = [];
			$this->form[] = ['label'=>'Image','name'=>'image','type'=>'filemanager','width'=>'col-sm-10','help'=>'1894 * 438'];
