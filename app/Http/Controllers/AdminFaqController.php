<?php namespace App\Http\Controllers;
	...
	class AdminFaqController extends \crocodicstudio_voila\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col = [];
			$this->col[] = ["label"=>"Question En","name"=>"question_en"];
			...
			$this->form = [];
			$this->form[] = ['label'=>'Question En','name'=>'question_en','type'=>'textarea','validation'=>'required','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'Response En','name'=>'response_en','type'=>'wysiwyg','width'=>'col-sm-10'];
			...
			//$this->form[] = ['label'=>'Question En','name'=>'question_en','type'=>'textarea','validation'=>'required','width'=>'col-sm-10'];
			//$this->form[] = ['label'=>'Response En','name'=>'response_en','type'=>'wysiwyg','width'=>'col-sm-10'];
			//$this->form[] = ['label'=>'Ip','name'=>'ip','type'=>'text','width'=>'col-sm-9','dataenum'=>'1|yes;0|no'];
	        ...
	        */
	        $this->load_css = array();
			$this->index_button[] = ['label' => 'Set SEO', 'title' => 'seo', 'url' => '/modules/seo/faq', "icon" => "fa fa-globe"];
