<?php namespace App\Http\Controllers;
	...
	class AdminTermsController extends \crocodicstudio_voila\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			//$this->form[] = ["label"=>"Desc Fr","name"=>"desc_fr","type"=>"textarea","required"=>TRUE,"validation"=>"required|string|min:5|max:5000"];
			//$this->form[] = ["label"=>"Title En","name"=>"title_en","type"=>"text","required"=>TRUE,"validation"=>"required|min:1|max:255"];
			//$this->form[] = ["label"=>"Title Fr","name"=>"title_fr","type"=>"text","required"=>TRUE,"validation"=>"required|min:1|max:255"];
