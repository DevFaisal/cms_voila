<?php namespace App\Http\Controllers;
	...
	class AdminContactUsController extends \crocodicstudio_voila\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col[] = ["label"=>"Known By","name"=>"known_by"];
			...
			$this->form[] = ['label'=>'Email','name'=>'email','type'=>'email','validation'=>'required|string|min:5|max:5000|email|unique:contact_us','width'=>'col-sm-10','placeholder'=>'Please enter a valid email address'];
			$this->form[] = ['label'=>'Country','name'=>'country','type'=>'textarea','validation'=>'required|string|min:5|max:5000','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'Comment','name'=>'comment','type'=>'textarea','validation'=>'required|string|min:5|max:5000','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'Known By','name'=>'known_by','type'=>'textarea','validation'=>'required|string|min:5|max:5000','width'=>'col-sm-10'];
			...
			//$this->form[] = ["label"=>"Email","name"=>"email","type"=>"email","required"=>TRUE,"validation"=>"required|string|min:5|max:5000|email|unique:contact_us","placeholder"=>"Please enter a valid email address"];
			//$this->form[] = ["label"=>"Country","name"=>"country","type"=>"textarea","required"=>TRUE,"validation"=>"required|string|min:5|max:5000"];
			//$this->form[] = ["label"=>"Comment","name"=>"comment","type"=>"textarea","required"=>TRUE,"validation"=>"required|string|min:5|max:5000"];
			//$this->form[] = ["label"=>"Known By","name"=>"known_by","type"=>"textarea","required"=>TRUE,"validation"=>"required|string|min:5|max:5000"];
