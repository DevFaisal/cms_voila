<?php namespace App\Http\Controllers;
	...
	class AdminDistributorsController extends \crocodicstudio_voila\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->form[] = ['label'=>'Image','name'=>'image','type'=>'filemanager','width'=>'col-sm-10','help'=>'123 * 24'];
