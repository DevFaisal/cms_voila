<?php namespace App\Http\Controllers;
	...
	class AdminNewsController extends \crocodicstudio_voila\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->form[] = ['label'=>'Description En','name'=>'description_en','type'=>'wysiwyg','width'=>'col-sm-10'];
			...
			$this->form[] = ['label'=>'Image','name'=>'image','type'=>'filemanager','width'=>'col-sm-9','help'=>'350* 282'];
			...
			//$this->form[] = ['label'=>'Description En','name'=>'description_en','type'=>'wysiwyg','width'=>'col-sm-10'];
			//$this->form[] = ['label'=>'Description Fr','name'=>'description_fr','type'=>'wysiwyg','width'=>'col-sm-10'];
			//$this->form[] = ['label'=>'Date','name'=>'date','type'=>'date','width'=>'col-sm-10'];
			//$this->form[] = ['label'=>'Active','name'=>'active','type'=>'radio','width'=>'col-sm-10','dataenum'=>'1|yes;0|no'];
			//$this->form[] = ['label'=>'Image','name'=>'image','type'=>'filemanager','width'=>'col-sm-9','help'=>'770 * 428'];
			# OLD END FORM
	        ...
	        */
			...
			$this->addaction[] = ['label' => '', 'title' => 'SEO', 'target' => '_blank', 'url' => '/modules/seo/news/[id]', 'icon' => 'fa fa-globe', 'color' => 'success', 'showIf' => "true"];
			$this->index_button[] = ['label' => 'Set SEO', 'title' => 'seo', 'url' => '/modules/seo/news', "icon" => "fa fa-globe"];
