<?php namespace App\Http\Controllers;
	...
	class AdminHighlightsController extends \crocodicstudio_voila\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->form[] = ['label'=>'Link','name'=>'link','type'=>'text','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'Label En','name'=>'label_en','type'=>'wysiwyg','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'Image','name'=>'image','type'=>'filemanager','width'=>'col-sm-10','help'=>'1349 * 500'];
			...
			//$this->form[] = ['label'=>'Link','name'=>'link','type'=>'text','width'=>'col-sm-10'];
			//$this->form[] = ['label'=>'Label En','name'=>'label_en','type'=>'wysiwyg','width'=>'col-sm-10'];
			//$this->form[] = ['label'=>'Label Fr','name'=>'label_fr','type'=>'wysiwyg','width'=>'col-sm-10'];
			//$this->form[] = ['label'=>'Image','name'=>'image','type'=>'filemanager','width'=>'col-sm-10','help'=>'1894 * 834'];
			//$this->form[] = ['label'=>'Active','name'=>'active','type'=>'radio','width'=>'col-sm-10','dataenum'=>'1|yes;0|no'];
			# OLD END FORM
