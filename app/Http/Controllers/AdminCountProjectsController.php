<?php namespace App\Http\Controllers;
	...
	class AdminCountProjectsController extends \crocodicstudio_voila\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->table = "count_projects";
			# END CONFIGURATION DO NOT REMOVE THIS LINE

			# START COLUMNS DO NOT REMOVE THIS LINE
			$this->col = [];
			$this->col[] = ["label"=>"Name En","name"=>"name_en"];
			$this->col[] = ["label"=>"Count","name"=>"count"];
			...
			$this->form[] = ['label'=>'Count','name'=>'count','type'=>'number','validation'=>'required|integer|min:0','width'=>'col-sm-10'];
