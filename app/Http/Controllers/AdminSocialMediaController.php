<?php namespace App\Http\Controllers;
	...
	class AdminSocialMediaController extends \crocodicstudio_voila\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col[] = ["label"=>"link","name"=>"value"];
			...
			$this->form = [];
			$this->form[] = ['label'=>'Title ','name'=>'title_en','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'link','name'=>'value','type'=>'text','width'=>'col-sm-10'];
			...
			//$this->form[] = ["label"=>"Title Ar","name"=>"title_ar","type"=>"text","required"=>TRUE,"validation"=>"required|min:1|max:255"];
	        ...
	        */
			...
			// $icon=\DB::table('statistics')->select('icon')->where('id',1)->first();
			// dd($this->col);
