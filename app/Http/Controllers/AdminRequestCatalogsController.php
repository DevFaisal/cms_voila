<?php namespace App\Http\Controllers;
	...
	class AdminRequestCatalogsController extends \crocodicstudio_voila\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col[] = ["label"=>"Download Count","name"=>"download_count"];
			$this->col[] = ["label"=>"Ip","name"=>"ip"];
			$this->col[] = ["label"=>"Admin Note","name"=>"admin_note"];
			...
			$this->form[] = ['label'=>'Country','name'=>'country','type'=>'text','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'Company','name'=>'company','type'=>'text','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'Tel','name'=>'tel','type'=>'text','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'Code','name'=>'code','type'=>'text','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'Download Count','name'=>'download_count','type'=>'number','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'Catalog Id','name'=>'catalog_id','type'=>'select2','width'=>'col-sm-10','datatable'=>'catalogues,name_en'];
			$this->form[] = ['label'=>'Active','name'=>'active','type'=>'radio','width'=>'col-sm-10','dataenum'=>'1|yes;0|no'];
			$this->form[] = ['label'=>'Admin Note','name'=>'admin_note','type'=>'textarea','width'=>'col-sm-9'];
	        ...
	        */
			...
			$this->addaction[] = ['label' => 'Send', 'title' => 'Send Mail', 'target' => '_blank', 'url' => '/send-code/[id]', 'icon' => 'fa fa-mail', 'color' => 'success', 'showIf' => "true"];
