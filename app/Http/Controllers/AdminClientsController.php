<?php namespace App\Http\Controllers;
	...
	class AdminClientsController extends \crocodicstudio_voila\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->form[] = ['label'=>'Link','name'=>'link','type'=>'text','validation'=>'required','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'Logo','name'=>'logo','type'=>'filemanager','width'=>'col-sm-10','help'=>'130 * 50'];
			...
			//$this->form[] = ['label'=>'Link','name'=>'link','type'=>'text','validation'=>'required','width'=>'col-sm-10'];
			//$this->form[] = ['label'=>'Logo','name'=>'logo','type'=>'filemanager','width'=>'col-sm-10','help'=>'123 * 24'];
			//$this->form[] = ['label'=>'Description En','name'=>'description_en','type'=>'wysiwyg','width'=>'col-sm-10'];
			//$this->form[] = ['label'=>'Description Fr','name'=>'description_fr','type'=>'wysiwyg','width'=>'col-sm-10'];
			//$this->form[] = ['label'=>'Active','name'=>'active','type'=>'radio','validation'=>'required','width'=>'col-sm-10','dataenum'=>'1|yes;0|no'];
			# OLD END FORM
