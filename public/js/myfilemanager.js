...
function OpenInsertImage(moduleNameparm,id) {
    ...
    $("#modalInsertPhoto .modal-body").html(`<iframe width="100%" height="800" src="/js/includes/filemanager/dialog.php?type=2&field_id=list_images" frameborder="0" style="overflow: scroll; overflow-x: hidden; overflow-y: scroll; "></iframe>`);
